      ...
      <div className="mx-auto my-3 grid max-w-6xl grid-cols-[repeat(auto-fit,300px)] justify-center gap-5 px-3">
        {
          portfolioData.map(portfolio => (
            <article key={portfolio.title} className='group/portfolio relative cursor-pointer overflow-hidden rounded-md border border-primary p-3 transition-all'>
              ...
              <div className='absolute left-0 right-0 top-[100%] grid h-[100%] w-[100%] place-content-center space-y-3 overflow-hidden rounded-t-[100px] bg-primary-medium/80 backdrop-blur-sm transition-all duration-500 group-hover/portfolio:top-0 group-hover/portfolio:rounded-t-none'>
                <p className='text-balance px-3 text-white delay-500 duration-500 group-hover/portfolio:top-0'>
